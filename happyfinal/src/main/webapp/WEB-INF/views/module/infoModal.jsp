...
<div style="font-family: Jal_Onuel;" class="modal text-black"
	id="myInfo">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="modifyform" method="post" action="">
					...
					<div class="form-group">
						<label for="uid">아이디:</label> <input type="text" name="info_id"
							id="info_id" class="form-control" value="${userinfo.userId}"
							readonly="readonly">
					</div>

					<div class="form-group">
						<label for="pwd">비밀번호:</label> <input type="text" name="info_pw"
							id="info_pw" class="form-control"
							placeholder="${userinfo.userPwd}" value="${userinfo.userPwd}">
					</div>

					<div class="form-group">
						<label for="pwd">주소 :</label> <input type="text"
							name="info_address" id="info_pw" class="form-control"
